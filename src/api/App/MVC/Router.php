...
class Router
{
  ...
  public function run($uri)
  {
    ...
    if (JSON::isValid($json) && (new JSONObject($json))->has('REQUEST_METHOD')) {
      $REQUEST_METHOD = (new JSONObject($json))->optString('REQUEST_METHOD');
    } else if (isset($_POST['REQUEST_METHOD'])) {
