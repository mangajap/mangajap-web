...
export class Manga extends JsonApiModel {
  ...
  @JsonApiAttribute() endDate?: string;
  @JsonApiAttribute() origin?: string;
  @JsonApiAttribute() status?: string;
  @JsonApiAttribute() mangaType?: string;
  @JsonApiAttribute() volumeCount?: number;
  @JsonApiAttribute() chapterCount?: number;
  ...
  @JsonApiAttribute() bannerImage?: string;

  @JsonApiRelationship() volumes?: Volume[] = [];
