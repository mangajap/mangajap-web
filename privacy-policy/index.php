...
<html>
<head>
    <title>Politique de Confidentialité | MangaJap</title>
...
<main class="container">
    ...
    <p>MangaJap ("nous", "notre", "nos") exploite l'application mobile MangaJap (ci-après désignée par le terme "Service").</p>

    <p>Cette page vous explique nos politiques en matière de collecte, d'utilisation et de communication des données à caractère personnel lorsque vous utilisez notre Service ainsi que les choix qui s'offrent à vous en ce qui concerne ces données. Our Privacy Policy  for MangaJap is created with the help of the <a href="https://www.privacypolicies.com/">PrivacyPolicies.com Privacy Policy Generator</a>.</p>
    ...
    <ul>
        <li>
            ...
            <p>Par Service on entend l'application mobile MangaJap exploitée par MangaJap</p>
        </li>
        <li>
    ...
    <ul>
        <li>Adresse e-mail</li>    <li>Prénom et nom de famille</li>    <li>Numéro de téléphone</li>        <li>Cookies et Données d'Utilisation</li>
    </ul>

    <h4>Données d'Utilisation</h4>

    <p>Lorsque vous accédez au Service au moyen d'un dispositif mobile, il se peut que nous recueillions certaines informations automatiquement, y compris, mais de manière non limitative, le type de dispositif mobile que vous utilisez, l'identifiant unique de votre dispositif mobile, l'adresse IP de votre dispositif mobile, votre système d'exploitation mobile, le type de navigateur Internet mobile que vous utilisez, les identifiants uniques de dispositifs ainsi que d'autres données de diagnostic ("Données d'Utilisation").</p>
    ...
    <p>MangaJap utilise les données recueillies à des fins diverses:</p>
    <ul>
    ...
    <ul>
        <li>Par courrier électronique: stantanasi@gmail.com</li>
